...
const FarmerOrderHistoryScreen = ({ onBack, onHelpClick }) => {
    ...
    return (
        <div className="min-h-screen bg-[#1B1109] flex flex-col relative overflow-x-hidden pb-12">
            ...
            {/* Fab for Reports */}
            <button className="fixed bottom-10 right-1/2 translate-x-[calc(min(640px,50vw)-3.5rem)] w-14 h-14 bg-[#A8D070] rounded-full shadow-2xl flex items-center justify-center active:scale-90 transition-all border-4 border-[#1B1109] text-[#1B1109] z-50">
