...
const FarmerHome = ({ onNavigate, onAddItem, onRevenueClick, onProfileClick, onSettingsClick, onNotificationClick, onReviewsClick, onHelpClick, onLocationClick }) => {
    ...
    return (
        <div className="min-h-screen bg-[#1B1109] flex flex-col relative pb-32 overflow-hidden">
            ...
            {/* Scrollable Content */}
            <div className="flex-1 px-6 pt-16 overflow-y-auto no-scrollbar relative z-10 w-full max-w-6xl mx-auto">
            ...
            <div className="fixed bottom-10 left-1/2 -translate-x-1/2 w-[90%] max-w-[600px] h-24 bg-[#A8D070] rounded-[48px] flex items-center justify-between px-10 shadow-[0_20px_50px_rgba(168,208,112,0.3)] z-50">
                <button
