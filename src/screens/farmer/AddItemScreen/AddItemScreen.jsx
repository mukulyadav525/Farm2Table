...
const AddItemScreen = ({ onBack, onSave, onHelpClick }) => {
    ...
    return (
        <div className="min-h-screen bg-[#1B1109] flex flex-col relative overflow-hidden pb-12">
            ...
            {/* Header */}
            <div className="max-w-3xl mx-auto w-full px-6 pt-16 pb-6 relative z-20">
            ...
            <div className="flex-1 px-6 overflow-y-auto no-scrollbar relative z-10 max-w-3xl mx-auto w-full">
                ...
                <div className="mb-8 mt-4">
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-[32px] p-2 flex items-center group focus-within:border-[#A8D070]/50 transition-all duration-500">
                        <div className="w-14 h-14 bg-[#A8D070]/10 rounded-[24px] flex items-center justify-center text-2xl group-focus-within:scale-110 transition-transform text-white">
                            🍓
                        </div>
                        <input
                            type="text"
                ...
                <div className="mb-8">
                    ...
                    <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar">
                        ...
                        {/* Add Slots */}
                        <button className="w-32 h-32 rounded-[32px] bg-white/5 border border-dashed border-white/10 flex flex-col items-center justify-center gap-2 group hover:border-[#A8D070]/50 transition-all shrink-0 text-white">
                ...
                <div className="flex flex-col gap-4 mb-10 text-white">
                    ...
                    >
                        ...
                        <div className="w-8 h-8 bg-[#1B1109]/10 rounded-xl flex items-center justify-center group-hover:rotate-12 transition-transform">
                            <PencilSquareIcon className="w-5 h-5 text-[#1B1109]" />
                        </div>
                    </button>
                    <button
                        onClick={() => { setItemName(''); setPrice(''); setPickup(false); setDelivery(false); }}
