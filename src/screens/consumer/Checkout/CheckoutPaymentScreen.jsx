...
const CheckoutPaymentScreen = ({ onBack, onConfirm, onHelpClick, total = 96 }) => {
    ...
    return (
        <div className="min-h-screen bg-[#1B1109] flex flex-col relative p-6 pt-12">
            <div className="flex items-center justify-between mb-10">
                ...
                <button onClick={onHelpClick} className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center text-white active:scale-90">
