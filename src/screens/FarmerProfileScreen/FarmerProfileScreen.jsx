    ...
    return (
        <div className="min-h-screen bg-[#1B1109] relative flex flex-col pb-32 overflow-x-hidden">
            ...
            <div className="relative h-72 w-full overflow-hidden">
                ...
                {/* Header Actions */}
                <div className="absolute top-0 left-0 right-0 px-6 pt-12 flex justify-between items-center z-20">
                    <button
                        onClick={onBack}
            ...
            {/* Stats Horizons */}
            <div className="mt-4 px-6 overflow-x-auto no-scrollbar flex gap-5 pb-8">

                {/* Card 1: Today's Frequency (Green Variant) */}
                <div
                    onClick={() => onNavigate('farmerTodayStats')}
                    className="min-w-[300px] bg-[#A8D070] rounded-[48px] p-8 relative flex flex-col shadow-2xl shadow-[#A8D070]/20 active:scale-95 transition-all cursor-pointer group"
                >
                ...
                <div
                    ...
                    className="min-w-[300px] bg-[#FF7043] rounded-[48px] p-8 relative flex flex-col shadow-2xl shadow-[#FF7043]/20 active:scale-95 transition-all cursor-pointer group"
                >
